...
const Contactus = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contact Festival Crackers
        </title>
        <meta
          name="description"
          content="Reach out to Festival Crackers for orders, queries, or wholesale deals. We're happy to help with anything related to fireworks."
        />
        <meta
          name="keywords"
          content="contact sivakasi crackers, Festival Crackers contact, fireworks supplier phone, email crackers support"
        />
        <meta property="og:title" content="Contact Festival Crackers" />
        <meta
          property="og:description"
          content="Have questions or want to place a bulk order? Contact Festival Crackers, your fireworks expert from Sivakasi."
        />
        <meta property="og:image" content="/meta/contact-us.jpg" />
        <meta property="og:url" content="https://festivalcrackers.com/contactus" />
      </Helmet>
      <section className="bg-gray-50 min-h-screen pt-20 pb-16 px-4 md:px-10">
        ...
        <div className="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">www.festivalcrackers.com</p>
          </div>
